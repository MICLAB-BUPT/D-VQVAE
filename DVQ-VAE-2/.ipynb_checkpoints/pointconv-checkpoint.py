...
class PointConvDensityClsSsg(nn.Module):
    def __init__(self, num_classes = 40):
        ...
        self.sa5 = PointConvDensitySetAbstraction(npoint=512, nsample=32, in_channel=256 + 3, mlp=[256, 128, 128], bandwidth = 0.2, group_all=False)
        self.sa6 = PointConvDensitySetAbstraction(npoint=3000, nsample=64, in_channel=128 + 3, mlp=[128, 64, 64], bandwidth = 0.1, group_all=False)
